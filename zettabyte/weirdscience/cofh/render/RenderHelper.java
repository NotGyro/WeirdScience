package zettabyte.weirdscience.cofh.render;
...
public final class RenderHelper {
	...
	public static final ResourceLocation MC_BLOCK_SHEET = new ResourceLocation(
			"textures/atlas/blocks.png");
	public static final ResourceLocation MC_ITEM_SHEET = new ResourceLocation(
			"textures/atlas/items.png");
	public static final ResourceLocation MC_FONT_DEFAULT = new ResourceLocation(
			"textures/font/ascii.png");
	public static final ResourceLocation MC_FONT_ALTERNATE = new ResourceLocation(
	...
	public static void setColor4ub(int color) {
		...
		GL11.glColor4ub((byte) (color >> 24 & 0xFF),
				(byte) (color >> 16 & 0xFF), (byte) (color >> 8 & 0xFF),
				(byte) (color & 0xFF));
	}
	...
	public static void renderItemAsBlock(RenderBlocks renderer, ItemStack item,
	...
	public static void renderIcon(Icon icon, double z) {
		...
		Tessellator.instance.addVertexWithUV(0, 16, z, icon.getMinU(),
				icon.getMaxV());
		Tessellator.instance.addVertexWithUV(16, 16, z, icon.getMaxU(),
				icon.getMaxV());
		Tessellator.instance.addVertexWithUV(16, 0, z, icon.getMaxU(),
				icon.getMinV());
		Tessellator.instance.addVertexWithUV(0, 0, z, icon.getMinU(),
				icon.getMinV());
		Tessellator.instance.draw();
	}

	public static void renderIcon(int x, int y, int z, Icon icon, int width,
			int height) {
	...
	public static final void bindItemTexture(ItemStack stack) {
		...
		engine().bindTexture(
				stack.getItemSpriteNumber() == 0 ? MC_BLOCK_SHEET
						: MC_ITEM_SHEET);
	}
