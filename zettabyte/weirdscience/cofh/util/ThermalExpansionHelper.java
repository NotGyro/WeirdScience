...
public class ThermalExpansionHelper {
	...
	/**
	 * Use this to register an Ore TYPE as a "Blast" recipe - it will require
	 * Pyrotheum Dust to smelt. Do not add the prefix. This is an opt-in for
	 * ores which do NOT have vanilla furnace recipes.
	 * 
	...
	public static void addMagmaticFuel(String fluidName, int energy) {
		...
		FMLInterModComms
				.sendMessage("ThermalExpansion", "MagmaticFuel", toSend);
	}
