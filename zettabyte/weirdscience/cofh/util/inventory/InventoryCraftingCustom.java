...
public class InventoryCraftingCustom extends InventoryCrafting {
	...
	public InventoryCraftingCustom(Container container, int rows, int columns,
			IInventory masterTile, int startingInventoryIndex) {
	...
	public ItemStack getStackInSlot(int slot) {
		...
		return slot >= this.getSizeInventory() ? null : myMaster
				.getStackInSlot(invOffset + slot);
	}
