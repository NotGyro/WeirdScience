 ...
 * 
 * It is expected that this will have limited use, so this is a child class for
 * overhead performance reasons.
 * 
 * @author King Lemming
 * 
 */
public class ComparableItemStackNBT extends ComparableItemStack {
	...
	public boolean isStackEqual(ComparableItemStack other) {
		...
		return super.isStackEqual(other)
				&& isStackTagEqual((ComparableItemStackNBT) other);
	}

	private boolean isStackTagEqual(ComparableItemStackNBT other) {

		return tag == null ? other.tag == null : other.tag == null ? false
