package zettabyte.weirdscience.cofh.util.inventory;

import net.minecraft.item.Item;
import net.minecraft.item.ItemStack;
import net.minecraftforge.oredict.OreDictionary;
import zettabyte.weirdscience.cofh.util.ItemHelper;

/**
 * This class allows for OreDictionary-compatible ItemStack comparisons.
 * 
 * The intended purpose of this is for things such as Recipe Handlers or
 * HashMaps of ItemStacks.
 * 
 * @author King Lemming
 * 
 */
public class ComparableItemStack {
	...
	public boolean isItemEqual(ComparableItemStack other) {
		...
		return other != null
				&& (oreID != -1 && oreID == other.oreID || itemID == other.itemID
	...
	public ItemStack toItemStack() {
		...
		return itemID < 0 || itemID >= 32000 ? null : new ItemStack(itemID,
				stackSize, metadata);
	}
