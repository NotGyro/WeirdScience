...
public final class StringHelper {
	...
	public static String shiftForInfo = LIGHT_GRAY
			+ localize("message.zettabyte.weirdscience.cofh.holdShift1") + " " + YELLOW + ITALIC
			+ localize("message.zettabyte.weirdscience.cofh.holdShift2") + " " + END + LIGHT_GRAY
			+ localize("message.zettabyte.weirdscience.cofh.holdShift3") + END;
