...
public class ElementEnergyStored extends ElementBase {
	...
	public static final ResourceLocation DEFAULT_TEXTURE = new ResourceLocation(
			GuiProps.PATH_ELEMENTS + "Energy.png");
	public static final int DEFAULT_SCALE = 42;

	protected IEnergyStorage storage;

	public ElementEnergyStored(GuiBase gui, int posX, int posY,
	...
	public void draw() {
		...
		int qty = getScaled();
		drawTexturedModalRect(posX, posY + DEFAULT_SCALE - qty, 16,
				DEFAULT_SCALE - qty, sizeX, qty);
	}
	...
	int getScaled() {
		...
		return MathHelper.round(storage.getEnergyStored() * sizeY
